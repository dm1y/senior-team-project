...
MainListener::MainListener(Ogre::RenderWindow *mainWindow, InputHandler *inputManager, World *world, PongCamera *cam) :
mRenderWindow(mainWindow), mInputHandler(inputManager), mWorld(world), mPongCamera(cam)
{
	x = 0;
}
